...
function formatWithHeaderFooter(message) {
    const COMPANY_HEADER = getSetting('company_header', "📱 DATAGATE 📱\n\n");
    const FOOTER_SEPARATOR = "\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n";
    const FOOTER_INFO = FOOTER_SEPARATOR + getSetting('footer_info', "Powered by INETmedia");
...
#KoneksiStabil #TheRealFastesInterconnected`
    },
    {
        title: "Tips Mengatur WiFi untuk Kecepatan Optimal",
        content: `Hai Pelanggan Setia Kami! ✨
...
4. Jangan perna membagikan sandi (cukup bagikan dengan fitur hotspot melalui HP)
5. Sembunyikan SSID jika perlu (Bagi yang sudah expert) (router tidak akan muncul di daftar WiFi umum)
