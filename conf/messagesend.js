...
function getHeaderFooter() {
    try {
        ...
        return {
            header: settings.company_header || 'DataGate Manage Bot',
            footer: settings.footer_info || 'The Real Fastes InterConnected'
        };
    } catch (error) {
        return {
            header: 'DataGate Manage Bot',
            footer: 'The Real Fastes InterConnected'
        };
    }
}
