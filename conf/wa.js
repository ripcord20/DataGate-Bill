...
async function connectToWhatsApp() {
    try {
        ...
        sock = makeWASocket({
            auth: state,
            logger,
            browser: ['DATAGATE Genieacs Bot Mikrotik', 'Chrome', '1.0.0'],
        ...
        sock.ev.on('connection.update', (update) => {
            ...
            if (connection === 'open') {
                ...
                try {
                    ...
                    const companyHeaderShort = getSetting('company_header_short', 'DATAGATE');
                    ...
                    `📞 *Dukungan Pengembang:*\n` +
                    `• E-WALLET: 08525998865\n` +
                    `• BCA: 1800945492 a.n Robin.M\n\n` +
